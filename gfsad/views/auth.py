...
from gfsad.auth import decode_token, generate_token, make_jwt
...
@limiter.limit("10 per hour", methods=['POST'], error_message="Try again in an hour.", key_func=lambda: request.json['email'] if (
